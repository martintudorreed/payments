...
@Component({
  selector: 'app-header-triage',
  templateUrl: './header-triage.component.html',
  styleUrls: ['./header-triage.component.scss']
})
export class HeaderTriageComponent {
  ...
  navLinks = [
    {location:'https://www.tult.co.nz/triage',label:'Jobs Today'},
    {location: 'https://www.tult.co.nz/triage', label: 'Reports'},
    {location:'https://www.tult.co.nz/triage',label:'Follow-ups'},
